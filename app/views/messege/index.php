 ...
 <nav class="navbar">
      ...
      <div class="more">
        ...
        <img src="<?=IMG ;?>person.jpg" alt="User Profile Picture" />
      </div>
    </nav>
    <!-- end navbar -->
    ...
    <div class="container">
      ...
      <nav class="sidebar">
        ...
        <div id="scrollableDiv" class="chat-list">
          <a class="chat" href="#">
            <img class="pp" src="<?=IMG ;?>person.jpg" alt="" />
            <div class="name-chat">
              <h2>Bos Besar</h2>
            ...
            <img class="indikator" src="<?=IMG ;?>person.jpg" alt="" />
          </a>
          <a class="chat" href="#">
            <img class="pp" src="<?=IMG ;?>person.jpg" alt="" />
            <div class="name-chat">
      ...
      <div id="info" class="info">
        <img class="info-pp" src="<?=IMG ;?>person.jpg" alt="" class="your-pp" />
        <div class="info-name">
          <h2>Bos Besar</h2>
